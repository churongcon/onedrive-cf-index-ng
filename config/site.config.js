...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'hotro@hinhanhhoc.com',

  // [OPTIONAL] This is the website icon to the left of the title inside the navigation bar. It should be placed under the
  // /public directory of your GitHub project (not your OneDrive folder!), and referenced here by its relative path to /public.
  icon: 'https://doctorplus.club/wp-content/uploads/2018/12/icon.jpg',

  // The name of your website. Present alongside your icon.
  title: "Doctor Plus Club",
  ...
  links: [
    {
      name: 'Trang chủ',
      link: 'https://doctorplus.club/',
    },
    {
      name: 'Mua VIP',
      link: 'https://doctorplus.club/nang-cap-thanh-vien-doctor-plus-club/',
    },
  ],
