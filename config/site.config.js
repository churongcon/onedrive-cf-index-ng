...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'data@hinhanhhoc.com',
  ...
  protectedRoutes: ['/Private', '/IV. Tài liệu/Lưu tạm/'],
